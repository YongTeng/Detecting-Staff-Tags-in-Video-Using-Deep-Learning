...
•	Optimizer: Adam with a learning rate of 0.001 <br />
•	Loss Function: Binary Crossentropy <br />
•	Metrics: Accuracy <br />
•	Training Duration: 10 epochs <br />
•	Data Split: 80% for training, 20% for validation <br />
...
Clustering Details: <br />
•	Number of Clusters: 2 <br />
•	Frame Representation: Each frame was reshaped into a one-dimensional vector for clustering. 

# 3.0 Results
## 3.1 CNN Model Results <br />
•	Training Accuracy (last epoch): 87.79% <br />
•	Validation Accuracy (last epoch): 81.25% <br />
•	Number of Frames with Staff Detected by CNN: 1341 <br />
...
•	Number of Frames with Staff Detected by K-Means: 874 <br />
